...
console.log();
var pkgCompatiblityString = (pkgLicenseType == licenseTypes.unknown || pkgLicenseType == licenseTypes.unlicensed) ? 'possibly incompatible' : 'incompatible';
                ...
                if (fs.existsSync(packageJsonFile)) {
                    fs.readFile(packageJsonFile, function(err, data) {
                        if (err) {
                            ...
                            if (moduleLicenseType == licenseTypes.unknown || moduleLicenseType == licenseTypes.unlicensed) console.log(modulePkg.name, '@', modulePkg.version, colors.red(moduleLicense ? moduleLicense : noLicenseStr), colors.yellow('(' + moduleLicenseType + ')', '-', colors.red('possibly incompatible'), 'with', colors.blue(pkgLicense ? pkgLicense : noLicenseStr), '(' + pkgLicenseType + ')'));
                            else
                            if (!forward_compatiblity(pkgLicenseType, moduleLicenseType)) console.log(modulePkg.name, '@', modulePkg.version, colors.red(moduleLicense), colors.yellow('(' + moduleLicenseType + ')', '-', colors.red(pkgCompatiblityString), 'with', colors.blue(pkgLicense ? pkgLicense : noLicenseStr), '(' + pkgLicenseType + ')'));
                            else
